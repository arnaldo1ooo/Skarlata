...
public class TableClientes extends JDialog {
	...
	public static void main(String[] args) {
		try {
			TableClientes dialog = new TableClientes();
	...
	public TableClientes() {
		...
		table = new JTable();
		MostrarResultSetEnJtable(AdministrarClientesSession.obtenerclientes());
		...
		cbFiltro.setModel(new DefaultComboBoxModel(new String[] { "Codigo", "Nombre", "Apellido", "Cedula", "Direccion", "Telefono", "Todos" }));
		cbFiltro.setSelectedIndex(6);
		...
		contentPanel.add(tBusqueda);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						clienteseleccionado = (String) table.getValueAt(row, 1) + " " + table.getValueAt(row, 2);
						AdministrarProyectos.tCodigoCliente.setText(codigoseleccionado + "");
						AdministrarProyectos.tNomApeCliente.setText(clienteseleccionado);
						AdministrarProyectos.tPropietario.setText(AdministrarProyectos.tNomApeCliente.getText());
						dispose();
					}
				});
				okButton.setIcon(new ImageIcon(TableClientes.class.getResource("/icono/Ok.png")));
			...
			}
			{
				...
				cancelButton.setIcon(new ImageIcon(TableClientes.class.getResource("/icono/Cancelar.png")));
	...
	public void filtro() {
		...
		if (cbFiltro.getSelectedItem() == "Hora entrada") {
			columnaABuscar = 4;
		}

		if (cbFiltro.getSelectedItem() == "Hora salida") {
			columnaABuscar = 5;
		}
